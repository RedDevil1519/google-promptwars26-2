 ...
 * - Configures the PWA plugin with a Web App Manifest for offline capability
...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Voter Protocol Engine',
        short_name: 'VoterProtocol',
        description: 'Your personalized civic voter roadmap — powered by Google AI.',
        theme_color: '#00d4ff',
      ...
      workbox: {
        // Cache the main app shell and API responses for offline use
